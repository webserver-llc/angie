...
Изменения в Angie 1.11.3                                          06.02.2026
    ...
    *) Безопасность: атакующий, находясь в позиции посредника (MITM) перед
       проксируемым сервером с использованием TLS, при некоторых независящих
       от него обстоятельствах мог внедрить в ответ данные в виде открытого
       текста до начала TLS-согласования (CVE-2026-1642); исправление
       портировано из nginx 1.29.5.
