...
Изменения в Angie 1.6.1                                           08.08.2024
    ...
    *) Добавление: счётчик "passed" в зоне API статистики, задаваемой
       директивой "status_zone" модуля "stream", для подсчёта соединений,
       переданных на обработку в другие слушающие сокеты при помощи директив
       "pass".
