...
typedef struct ngx_resolver_connection_s  ngx_resolver_connection_t;


struct ngx_resolver_connection_s {
    ...
    ngx_pool_t                 *pool;
    ngx_resolver_connection_t  *next;
    ngx_resolver_connection_t  *prev;
...
typedef struct {
    ...
    ngx_resolver_connection_t  *connection;
...
struct ngx_resolver_s {
    ...
    ngx_resolver_connection_t  *connections;
    ngx_resolver_connection_t  *last_conf_connection;
    ngx_resolver_connection_t  *current_connection;
