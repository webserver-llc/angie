...
static u_char ngx_http_server_string[] = "Server: Angie" CRLF;
static u_char ngx_http_server_full_string[] = "Server: " ANGIE_VER CRLF;
static u_char ngx_http_server_build_string[] = "Server: " ANGIE_VER_BUILD CRLF;
