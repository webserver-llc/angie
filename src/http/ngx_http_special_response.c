...
#define ngx_http_error_page(msg)                                              \
    ngx_http_error_page_ext(msg, msg, "")
...
static char ngx_http_error_301_page[] =
    ngx_http_error_page("301 Moved Permanently");

static char ngx_http_error_302_page[] =
    ngx_http_error_page("302 Found");

static char ngx_http_error_303_page[] =
    ngx_http_error_page("303 See Other");

static char ngx_http_error_307_page[] =
    ngx_http_error_page("307 Temporary Redirect");

static char ngx_http_error_308_page[] =
    ngx_http_error_page("308 Permanent Redirect");

static char ngx_http_error_400_page[] =
    ngx_http_error_page("400 Bad Request");

static char ngx_http_error_401_page[] =
    ngx_http_error_page("401 Unauthorized");

static char ngx_http_error_402_page[] =
    ngx_http_error_page("402 Payment Required");

static char ngx_http_error_403_page[] =
    ngx_http_error_page("403 Forbidden");

static char ngx_http_error_404_page[] =
    ngx_http_error_page("404 Not Found");

static char ngx_http_error_405_page[] =
    ngx_http_error_page("405 Method Not Allowed");

static char ngx_http_error_406_page[] =
    ngx_http_error_page("406 Not Acceptable");

static char ngx_http_error_407_page[] =
    ngx_http_error_page("407 Proxy Authentication Required");

static char ngx_http_error_408_page[] =
    ngx_http_error_page("408 Request Timeout");

static char ngx_http_error_409_page[] =
    ngx_http_error_page("409 Conflict");

static char ngx_http_error_410_page[] =
    ngx_http_error_page("410 Gone");

static char ngx_http_error_411_page[] =
    ngx_http_error_page("411 Length Required");

static char ngx_http_error_412_page[] =
    ngx_http_error_page("412 Precondition Failed");

static char ngx_http_error_413_page[] =
    ngx_http_error_page("413 Request Entity Too Large");

static char ngx_http_error_414_page[] =
    ngx_http_error_page("414 URI Too Long");

static char ngx_http_error_415_page[] =
    ngx_http_error_page("415 Unsupported Media Type");

static char ngx_http_error_416_page[] =
    ngx_http_error_page("416 Range Not Satisfiable");

static char ngx_http_error_421_page[] =
    ngx_http_error_page("421 Misdirected Request");

static char ngx_http_error_429_page[] =
    ngx_http_error_page("429 Too Many Requests");

static char ngx_http_error_494_page[] =
    ngx_http_error_page_ext(
        "400 Request Header Or Cookie Too Large", "400 Bad Request",
...
static char ngx_http_error_496_page[] =
    ngx_http_error_page_ext(
        "400 No required SSL certificate was sent", "400 Bad Request",
...
static char ngx_http_error_500_page[] =
    ngx_http_error_page("500 Internal Server Error");

static char ngx_http_error_501_page[] =
    ngx_http_error_page("501 Not Implemented");

static char ngx_http_error_502_page[] =
    ngx_http_error_page("502 Bad Gateway");

static char ngx_http_error_503_page[] =
    ngx_http_error_page("503 Service Unavailable");

static char ngx_http_error_504_page[] =
    ngx_http_error_page("504 Gateway Timeout");

static char ngx_http_error_505_page[] =
    ngx_http_error_page("505 HTTP Version Not Supported");

static char ngx_http_error_507_page[] =
    ngx_http_error_page("507 Insufficient Storage");
