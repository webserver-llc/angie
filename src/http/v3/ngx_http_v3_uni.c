...
{
    ngx_int_t                  index;
    ngx_uint_t                 encoder, decoder, control, streams;
    ngx_http_v3_session_t     *h3c;
    ngx_http_v3_uni_stream_t  *us;
    ...
    default:
        ...
        streams = (1 << encoder) | (1 << decoder) | (1 << control);
...
ngx_int_t
ngx_http_v3_send_settings(ngx_connection_t *c, ngx_http_v3_settings_t *settings)
{
    ...
    n += ngx_http_v3_encode_varlen_int(NULL, settings->max_table_capacity);
    n += ngx_http_v3_encode_varlen_int(NULL, NGX_HTTP_V3_PARAM_BLOCKED_STREAMS);
    n += ngx_http_v3_encode_varlen_int(NULL, settings->max_blocked_streams);
