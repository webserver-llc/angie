...
is(header_server('/off/200'), 'Angie', 'http2 tokens off 200');
is(header_server('/off/404'), 'Angie', 'http2 tokens off 404');
like(body('/off/404'), qr/Angie(?!\/)/, 'http2 tokens off 404 body');
