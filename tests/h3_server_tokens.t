...
is(header_server('/off/200'), 'Angie', 'http3 tokens off 200');
is(header_server('/off/404'), 'Angie', 'http3 tokens off 404');
like(body('/off/404'), qr/Angie(?!\/)/, 'http3 tokens off 404 body');
